...
from a2g.logging import typewriter_log, logger

if TYPE_CHECKING:
    from a2g.agents import BaseAgent, SolverAgent, CriticAgent
    from a2g.message import Message, CriticMessage, SolverMessage
